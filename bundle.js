...
.dark-background-showed {
  display: block;
}`, "",{"version":3,"sources":["webpack://./src/index.css"],"names":[],"mappings":"AAAA;EACE,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,mBAAmB;EACnB,sBAAsB;AACxB;;AAEA;EACE,aAAa;AACf;;;AAGA;EACE,YAAY;EACZ,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,YAAY;EACZ,kBAAkB;EAClB,UAAU;EACV,SAAS;EACT,2BAA2B;EAC3B,aAAa;EACb,aAAa;AACf;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,kBAAkB;EAClB,MAAM;EACN,SAAS;EACT,OAAO;EACP,QAAQ;EACR,gCAAgC;EAChC,aAAa;AACf;;AAEA;EACE,cAAc;AAChB","sourcesContent":[".container {\n  padding-top: 50px;\n}\n\npre {\n  font-size: 10px;\n  background: #f4f2f2;;\n  font-family: monospace;\n}\n\n.hidden {\n  display: none;\n}\n\n\n.upload-file-container {\n  width: 300px;\n  margin-bottom: 50px;\n}\n\n.alert {\n  font-size: 12px;\n  width: 260px;\n  margin: auto;\n  position: absolute;\n  top: 255px;\n  left: 50%;\n  transform: translateX(-50%);\n  padding: 10px;\n  z-index: 1000;\n}\n\n.alert-dismissible .btn-close {\n  padding: 13px;\n}\n\n.dark-background {\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background: rgba(000, 0, 0, 0.6);\n  display: none;\n}\n\n.dark-background-showed {\n  display: block;\n}"],"sourceRoot":""}]);
// Exports
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   onExcelUpload: () => (/* binding */ onExcelUpload)
/* harmony export */ });
/* harmony import */ var csv_parse_browser_esm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! csv-parse/browser/esm */ "./node_modules/csv-parse/dist/esm/index.js");
/* harmony import */ var _codeToPase__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./codeToPase */ "./src/js/codeToPase.ts");


var alert = document.querySelector('.alert');
var background = document.querySelector('.dark-background');
function getMapStudentIdToScore(data) {
    return data.reduce(function (prev, current) {
        var studentId = current["Email Address"].split('@')[0]; // Email Address
        var score = current["Total Sprint Review Score\n(formula)"];
        if (studentId && score) {
...
function onExcelUpload(reader) {
    (0,csv_parse_browser_esm__WEBPACK_IMPORTED_MODULE_0__.parse)(reader.result, { columns: true }, function (err, data) {
        if (data && Array.isArray(data)) {
            var mapStudentIdToScore = getMapStudentIdToScore(data);
            var code = (0,_codeToPase__WEBPACK_IMPORTED_MODULE_1__.getCodeToPaste)(mapStudentIdToScore);
...
/* harmony import */ var _onExcelUpload__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./onExcelUpload */ "./src/js/onExcelUpload.ts");


function onDrop(e) {
    var reader = new FileReader();
    reader.addEventListener('load', function () { return (0,_onExcelUpload__WEBPACK_IMPORTED_MODULE_1__.onExcelUpload)(reader); });
