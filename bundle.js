...
.upload-file-container {
  width: 300px;
}`, "",{"version":3,"sources":["webpack://./src/index.css"],"names":[],"mappings":"AAAA;EACE,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,mBAAmB;AACrB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,YAAY;EACZ,mBAAmB;AACrB;;AAEA;EACE,YAAY;AACd","sourcesContent":[".container {\n  padding-top: 50px;\n}\n\npre {\n  font-size: 10px;\n  background: #d1cdcd;\n}\n\n.hidden {\n  display: none;\n}\n\n.form-select {\n  width: 300px;\n  margin-bottom: 50px;\n}\n\n.upload-file-container {\n  width: 300px;\n}"],"sourceRoot":""}]);
// Exports
...
(function (Specialization) {
    Specialization["FS"] = "FS";
    Specialization["ML"] = "ML";
    Specialization["ARVR"] = "ARVR";
    Specialization["LAB"] = "LAB"; // C19:LAB
})(Specialization || (Specialization = {}));
var EventStatus;
(function (EventStatus) {
    EventStatus["PENDING"] = "Pending";
})(EventStatus || (EventStatus = {}));
var uploadFileContainer = document.querySelector('.upload-file-container');
var selectElement = document.querySelector('#spec-id');
    ...
    reader.onload = function () {
        (0,csv_parse_browser_esm__WEBPACK_IMPORTED_MODULE_0__.parse)(reader.result, { columns: true }, function (err, data) {
            ...
            if (data && Array.isArray(data)) {
                var mapStudentIdToScore = data.reduce(function (prev, current) {
